...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Product::create([
            ...
            'description' => ' 1 pechuga entera
            1 libra carne para desmechar
            5 chorizos medianos
            3 tarros maíz tierno
        ...
        Product::create([
            'name' => 'carne 3/4 dorado',
            'image' => ' https://cdn.pixabay.com/photo/2016/03/05/23/02/barbecue-1239434_640.jpg',
            'description' => ' pollo a la broster o pollo a la broaster, en qué se diferencian, lo mismo en pollo al spiedo, pollo al espiedo, pollo espiedero.',
            'quantity' => 100,
            'price' => 10000
        ]);
