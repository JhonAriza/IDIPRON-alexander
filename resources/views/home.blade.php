    ...
    <aside class="sidebar position-fixed top-0 left-0 overflow-auto h-100 float-left" id="show-side-navigation1">
        ...
        <div class="sidebar-header d-flex justify-content-center align-items-center px-3 py-4">
            <img class="rounded-pill img-fluid" width="65"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNB9ruk7YdwXJvDBuGc3-rhnbNq8FRctkbmRdRDRDgiw&s"
                alt="">
                        ...
                        <a type="button"  href=" {{url('graficas')}}"   class="btn btn-outline-primary">crear grafica de productos mas vendidos</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="quantity" class="input-group-text">
                                </div>
                                <div class="col-md-8 mt-3">
                                    <label for="">Descripción</label>
                                    <textarea name="description" class="input-group-text" cols="71" rows="3"></textarea>
                                </div>
